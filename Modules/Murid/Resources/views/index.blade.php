                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="card card-congratulation-medal">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('Assets/Backend/images/illustration/badge.svg') }}"
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder mb-0">
                                                        {{ strtoupper(Auth::user()->username) }}</h4>
                                                    @if (Auth::user()->member)
                                                        <p class="card-text font-small-1 mb-0">Member sejak
                                                            {{ Carbon\carbon::parse(Auth::user()->member->created_at)->format('d F Y') }}
                                                        </p>
                                                    @else
                                                        <p class="card-text font-small-1 mb-0 text-warning"> Belum menjadi
                                                            member Perpustakaan</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
