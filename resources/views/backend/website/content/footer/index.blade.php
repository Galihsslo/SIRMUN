                            ...
                            <div class="card-body">
                                <form action=" {{ route('backend-footer.store') }} " method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">Logo SIMUNIR</label> <span
                                                    class="text-danger">*</span>
                                                <input type="file"
                                                    class="form-control @error('logo') is-invalid @enderror" name="logo"
                                                    value=" {{ old('logo') }} " />
                                                <small class="text-danger" style="font-size: 10px">Ukuran yang disarankan
                                                    168x41 dengan format .png.</small>
                                                @error('logo')
                                                    <div class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">No Telepon</label> <span
                                                    class="text-danger">*</span>
                                                <input type="text"
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">No WhatsApp</label> <span
                                                    class="text-danger">*</span>
                                                <input type="text"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="basicInput">Deskripsi Singkat Yayasan</label> <span
                                                    class="text-danger">*</span>
                            ...
                            <div class="card-body">
                                <form action=" {{ route('backend-footer.update', $footer->id) }} " method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">Facebook</label> <span
                                                    class="text-danger">*</span>
                                                <input type="text"
                                                    class="form-control @error('facebook') is-invalid @enderror"
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">Instagram</label> <span
                                                    class="text-danger">*</span>
                                                <input type="text"
                                                    class="form-control @error('instagram') is-invalid @enderror"
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="basicInput">Logo Yayasan</label> <span
                                                    class="text-danger">*</span>
                                                <input type="file"
