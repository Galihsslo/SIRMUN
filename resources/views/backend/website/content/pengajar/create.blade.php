            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action=" {{ route('backend-pengajar.store') }} " method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="mengajar"
                                                ...
                                                <option>
                                                <option value="Matematika">Nahwu
                                                <option>
                                                <option value="Bahasa Arab">Bahasa Arab
                                                <option>
                                                <option value="Matematika">Tahfidzul Qur'an
                                                <option>
                                                <option value="Matematika">Bahasa inggris
                                                <option>
                                                <option value="Matematika">Bahasa Jawa
                                                <option>
                                                <option value="Matematika">Sains
                                                <option>
                                            </select>
                                            @error('mengajar')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('linkedln') is-invalid @enderror" name="linkedln"
                                                value=" {{ old('linkidln') }} " placeholder="Linkedln" />
                                            @error('linkedln')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
