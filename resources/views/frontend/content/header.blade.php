                    ...
                    <div class="header-top-left">
                        <div class="logo-area">
                            @if (@$footer->logo == null)
                                ...
                                <img class="img-responsive" src="{{ asset('Assets/Frontend/img/SIMUNIR.png') }}"
                                    alt="logo">
                            @else
                    ...
                    <div class="header-top-right">
                        <ul>
                            ...
                            <li><i class="fa fa-envelope" aria-hidden="true"></i><a
                                    href="#">{{ @$footer->email }}</a></li>
                            <li>
                                @auth
                                    {{-- <a href="/home" class="apply-now-btn2">Home</a> --}}
                                    <a href="/home" class="apply-now-btn2">{{ Auth::user()->name }}</a>
                                @else
                    ...
                    <nav id="dropdown">
                        <ul>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <li><a href="#">Tentang Kami</a>
                                    <ul>
                                        <li><a href=" {{ route('profile.sekolah') }} ">Profile Yayasan</a></li>
                                        <li><a href=" {{ route('visimisi.sekolah') }} ">Visi dan Misi</a></li>
                                    </ul>
                                </li>
